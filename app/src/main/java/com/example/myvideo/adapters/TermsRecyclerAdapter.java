...
public class TermsRecyclerAdapter extends RecyclerView.Adapter<TermsRecyclerAdapter.Holder>{
    ...
    ArrayList<UniversityModel.Grades.Departments.Terms> list = new ArrayList<>();

    public void setList(ArrayList<UniversityModel.Grades.Departments.Terms> list) {
        this.list = list;
    }
    ...
    public interface OnItemClick{
        ...
        void OnClick(UniversityModel.Grades.Departments.Terms term);
